...
export class ProviderDeletionQueue {
  private timer?:NodeJS.Timeout;private retryRun?:Promise<void>;private stopping=false;private flights=new Map<string,Promise<boolean>>();private operations=new Set<Promise<unknown>>();
