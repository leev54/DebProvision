...
export const commands=[
 ...
 new SlashCommandBuilder().setName('play').setDescription('Search for or play YouTube audio').addStringOption(string('query','Song, artist, search text, or YouTube URL')),
