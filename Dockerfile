...
RUN apt-get update && apt-get install -y --no-install-recommends ffmpeg yt-dlp ca-certificates && rm -rf /var/lib/apt/lists/* && useradd --system --uid 10001 --create-home bot
WORKDIR /app
